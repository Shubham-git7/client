...
const AdminProjects = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (selectedItemForEdit) {
        response = await axios.post("https://server-portfolio-sfdo.onrender.com/api/portfolio/update-project", {
          ...values,
          _id: selectedItemForEdit._id,
        });
      } else {
        response = await axios.post("https://server-portfolio-sfdo.onrender.com/api/portfolio/add-project", values);
      }
  ...
  const onDelete = async (item) => {
    try {
      dispatch(showLoading());
      const response = await axios.post("https://server-portfolio-sfdo.onrender.com/api/portfolio/delete-project", {
        _id: item._id,
      });
      dispatch(hideLoading());
      if (response.data.success) {
